...
namespace AppSharedMemory.ServiceMetier {
    ...
    public interface IService1 {
        ...
        AppSharedMemory.ServiceMetier.Jury[] GetsJury(string Nom, string Prenom, string Specialite);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/GetsJury", ReplyAction="http://tempuri.org/IService1/GetsJuryResponse")]
        System.Threading.Tasks.Task<AppSharedMemory.ServiceMetier.Jury[]> GetsJuryAsync(string Nom, string Prenom, string Specialite);
    }
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<AppSharedMemory.ServiceMetier.IService1>, AppSharedMemory.ServiceMetier.IService1 {
        ...
        public AppSharedMemory.ServiceMetier.Jury[] GetsJury(string Nom, string Prenom, string Specialite) {
            return base.Channel.GetsJury(Nom, Prenom, Specialite);
        }
        
        public System.Threading.Tasks.Task<AppSharedMemory.ServiceMetier.Jury[]> GetsJuryAsync(string Nom, string Prenom, string Specialite) {
